...
class QSidePanel(QScrollableGridWidget):
    ...
    def addItem(self, item: QSidePanelItem = QSidePanelItem()) -> None:
    ...
    def addItems(self, *items: QSidePanelItem) -> None:
        for item in items:
            self.addItem(item)

    def insertItem(self, index: int = 0, item: QSidePanelItem = QSidePanelItem()) -> None:
    ...
    @property
    def items(self) -> list[QSidePanelItem|QSidePanelSeparator]:
